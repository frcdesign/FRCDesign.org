...
<div class="slideshow-container">
  ...
  <div class="mySlides fade">
    <figure>
      <iframe src="https://www.youtube.com/embed/fDDM02mGCvg?rel=0" width="768" height="432" frameborder="0" allowfullscreen vq="hd1080"></iframe>
  ...
  <div class="mySlides fade">
    <figure>
      <iframe src="https://www.youtube.com/embed/0k2pSyg_nA0?rel=0" width="768" height="432" frameborder="0" allowfullscreen vq="hd1080"></iframe>
      <figcaption>2. Use Assembly Mirror to copy the plate to the other side.</figcaption>
    </figure>
  </div>
  <div class="mySlides fade">
    <figure>
      <iframe src="https://www.youtube.com/embed/J_dtYxcaCL8?rel=0" width="768" height="432" frameborder="0" allowfullscreen vq="hd1080"></iframe>
  ...
  <div class="mySlides fade">
    <figure>
      <iframe src="https://www.youtube.com/embed/DqiNcoXHYNE?rel=0" width="768" height="432" frameborder="0" allowfullscreen vq="hd1080"></iframe>
      <figcaption>4. Mate the belts to the rollers using the center mate point for the belts, and the roller pulleys.</figcaption>
    </figure>
  </div>
  <div class="mySlides fade">
    <figure>
      <iframe src="https://www.youtube.com/embed/BnFXhMRt_us?rel=0" width="768" height="432" frameborder="0" allowfullscreen vq="hd1080"></iframe>
  ...
  <div class="mySlides fade">
    <figure>
      <iframe src="https://www.youtube.com/embed/WUW7gB-it7I?rel=0" width="768" height="432" frameborder="0" allowfullscreen vq="hd1080"></iframe>
      <figcaption>6. Measure the distance between the plate and motor by clicking the face of each component. Copy this distance to your clipboard. Open the FRCDesignLib Inserter and insert a custom round ID spacer with the length you copied. There is no need to change other configurations. Attach this spacer to the plate and use replicate to add it to the other two plate holes.</figcaption>
    </figure>
  </div>
  <div class="mySlides fade">
    <figure>
      <iframe src="https://www.youtube.com/embed/FkXr6tEHoSc?rel=0" width="768" height="432" frameborder="0" allowfullscreen vq="hd1080"></iframe>
