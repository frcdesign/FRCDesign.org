...
!!! Warning
    As this is the first exercise where MKCAD is being used, please be sure you have it added by following [the tutorial in Stage 0!](../../../stage0/0B/MKCad/ "Adding MKCAD Tutorial Page"){:target="_blank"}
