...
![purple_cylinder](../../../img/learning-course/course-setup/theory/purplecyl.webp){align=right width=15%}
...
<img src="/img/learning-course/course-setup/theory/cross-light.webp#only-light" style="float:right; width:35%; margin-left:15px; margin-top:-30px">
<img src="/img/learning-course/course-setup/theory/cross-dark.webp#only-dark" style="float:right; width:35%; margin-left:15px; margin-top:-30px">
...
![extrude](../../../img/learning-course/course-setup/theory/extrude-light.webp#only-light){align=right width=40%} ![extrude](../../../img/learning-course/course-setup/theory/extrude-dark.webp#only-dark){align=right width=40%}
