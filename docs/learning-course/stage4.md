...
3. **Learn more engineering design.** Refer to the [design fundamentals pages](../design-handbook/index.md) and the deep dives in the [mechanism examples pages](../mechanism-examples/index.md). This includes how to assess potential forces on parts of the robot, pick the right materials, design rigid structures, learn more about what parts are available to FRC teams and how to use them effectively, and at a top level, what goes into designing good mechanisms.
