...
Use [simplified models](https://www.frcdesign.org/resources/simplified/ "Simplified Models Page") wherever possible to minimize primitives: for electronics, swerve modules, motors, etc. Some of these are added to MKCAD as well.
