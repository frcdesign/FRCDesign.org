---
title: "Materials"
description: "An overview of raw materials commonly found on FRC robots."
---
...
<Aside type="note">
For more information on materials used in 3D printing, like TPU or PLA, refer to the <a href="https://www.frcdesign.org/design-handbook/structure/intro-to-3d-printing/"target="_blank" rel="noopener noreferrer">Intro to 3D Printing</a> page for more information.
</Aside>
## Aluminum
...
Although many types of aluminum alloys exist, the most commonly used in FRC is **6061-T6** followed by **7075**. 6061 is best because of its ability to be both strong and easy to machine with. For most applications, it works well. However, in applications where more strength to handle higher loads is wanted, 7075 aluminum can be helpful. For more information on alloys aside from the two discussed, visit <a href="https://www.allmetalsfab.com/understanding-aluminum-alloys/"target="_blank" rel="noopener noreferrer">this website</a> to learn more.

<Aside type="note">
7075 aluminum is used in many COTS items, notably solid hex shafts and gears. It is important to note the alloy on vendor websites if attempting to machine or modify COTS items.
</Aside>
### Billet
